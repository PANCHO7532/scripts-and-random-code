...
//Descargando datos
$stage1 = curl_init('http://'.$server.'/syncGJAccount20.php');
curl_setopt ($stage1, CURLOPT_POST, 1);
curl_setopt ($stage1, CURLOPT_POSTFIELDS,"userName=$usr&password=$password&secret=Wmfv3899gc9&gameVersion=21&binaryVersion=33&gdw=0");
